...
- **Contribuições Pessoais**
  ...
  - Criei o sistema de sobreaviso e ajustei varias vezes ela. Criei as entidades Colaboradores e HoraExtra(Node.js/ElephantSQL)
  - Ajustei o Header do site (Node.js)
